...
pipeline_name = "[WORKSHOP] Retrain Model"
...
def pipeline(
    ...
    step_4 = setup_components(op_4, "Evaluation", image, secret_name)
    feature_selection_run_id = step_4.outputs["run_id"]
    step_4.after(step_3)


if __name__ == "__main__":
    pipeline_filename = f"retrain.yml"
